...
* [B:](http://asn.desire2learn.com/resources/S2696007) RDF数据模型
    ...
    * [C:](http://asn.desire2learn.com/resources/S2731590) 理解RDF语境中用于RDF词表或命名空间URI的命名空间在功能上与面向对象类的属性和功能的命名空间是如何具有本质区别的。
...
* [B:](http://asn.desire2learn.com/resources/S2696017) RDF 序列化
    * [C:](http://asn.desire2learn.com/resources/S2709805) 理解RDF序列化格式是一个给定三元组集合（RDF图）的交换编码格式。
        * [D:](http://asn.desire2learn.com/resources/S2731558) 使用工具在不同的RDF数据序列化格式之间互转。
...
* [B:](http://asn.desire2learn.com/resources/S2696044) 发现RDF词汇
   * [C:](http://asn.desire2learn.com/resources/S2731567)  知道如何通过数据门户与注册系统找到RDF词汇。
...
* [B:](http://asn.desire2learn.com/resources/S2731561) 设计RDF词汇
    ...
    * [C:](http://asn.desire2learn.com/resources/S2731568) 在必要时，为任何基于要求的新属性与类创建命名空间 URIs。
        * [D:](http://asn.desire2learn.com/resources/S2731569) 草拟为类和属性创建URI的政策。
...
* [B:](http://asn.desire2learn.com/resources/S2696087) RDF数据的查询
    * [C:](http://asn.desire2learn.com/resources/S2708689) 理解SPARQL 查询是由常量与变量组成的三元组模式，匹配结果为一个 RDF 图。
